...
function page() {
    const users = [
        {
            ...
            name: "Abdulla",
            email: "abuhoshimiv@gmail.com",
            id: 1,
        },
        { image: "", name: "xoji", email: "nojoiii@gmail.com", id: 2 },
        { image: "", name: "Asad", email: "ibbbbb@gmail.com", id: 3 },
        {
  ...
  setFilteredUsers(
    ...
    return (
        <div className="bg-gradient-to-r from-white  to-purple-50 border-[1px] border-purple-200   rounded-[20px] py-10 px-3 ">
            <div className="flex my-5 justify-between py-3 px-2 items-center ">
              <h2 className="text-[20px] font-semibold ">Foydalanuvchilar ro'yxati</h2>
              <input 
          value={inputValue} 
          onChange={(e) => handleSearch(e)} 
          className="px-[13px]  w-[25%] py-[6px]  border-[#d8d8d8] border-[1px] rounded-2xl" 
          placeholder={"Qidirish"}
        />
            </div>
            <div className=" space-y-5">
                { filteredUsers.length > 0 ?  filteredUsers.map((item: UserType) => (
                    <UserCard user={item} key={item.id} />
                )) : <div className="flex justify-center py-10 border-t-[1px] border-[#ECECEC] items-center"> <h2 className="font-semibold text-[20px] text-[#1a1a1a] ">Foydalanuvchilar  topilmadi</h2> </div>}
            </div>
        </div>
    );
}
